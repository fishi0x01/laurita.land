// modified from https://github.com/jchamill/jquery-quiz
...
;(function($, window, document, undefined) {
  ...
  $.quiz = function(el, options) {
    ...
    var questions = base.options.questions,
      ...
      allowedMisses = base.options.allowedMisses,
    ...
    base.methods = {
      ...
      setup: function() {
        ...
        $.each(questions, function(i, question) {
          ...
          if(question.imageSrc != null) {
            quizHtml += '<img src="' + question.imageSrc + '" width=' + question.imageWidth + '>';
          }
          quizHtml += '<br><p class="question">' + question.q + '</p>';
      ...
      finish: function() {
        if (score < numQuestions - allowedMisses) {
          $('#quiz-counter').hide();
          $('#quiz-response').hide();
          $('#quiz-finish-btn').hide();
          $('#quiz-next-btn').hide();
          base.methods.gameOver('Du hast nur ' + score + ' von ' + numQuestions + ' Fragen richtig beantwortet. Das reicht nicht.');
          return;
        }
